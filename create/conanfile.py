...
class PugixmlConan(ConanFile):
    ...
    description = "<Description of Pugixml here>"
    ...
    def source(self):
        self.run("git clone https://github.com/zeux/pugixml.git")
...
conan_basic_setup()''')
    ...
    def build(self):
        cmake = CMake(self)
        cmake.configure(source_folder="pugixml")
        cmake.build()

    def package(self):
        self.copy("*.hpp", dst="include", src="pugixml")
